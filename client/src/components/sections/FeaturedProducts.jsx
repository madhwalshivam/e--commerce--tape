      ...
      <div className="section-container">
        ...
        <div className="text-center mb-16 relative">
          <h2 className="font-sans text-3xl md:text-4xl font-bold tracking-tight uppercase mb-4">
            <span className="text-black">FEATURED</span> <span className="text-[#F7941D]">PRODUCTS</span>
          </h2>
          <div className="w-20 h-[3px] bg-[#F7941D] mx-auto mb-6 rounded-full" />
          <p className="text-gray-400 font-medium tracking-widest uppercase text-[12px]">Premium products for your daily needs</p>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex justify-center gap-4 mt-12 md:mt-16">
              ...
              <Link href="/products?featured=true" className="h-14 border-2 border-black flex items-center px-10 font-display font-black text-sm tracking-[0.2em] hover:bg-black hover:text-white transition-all uppercase">
                View All
              </Link>
